...
const response = await axios.post("https://plansplus.runasp.net/api/Authentication/Login",vaalues,
{
  headers: {
                  ...
                  <div className="grid grid-cols-1  ">
                    <div className=" my-8  ">
                      ...
                      <input
                        ...
                        className={` w-3/4 place-self-center md:w-3/4 placeholder:text-[#B0B0B0] placeholder-opacity-50 shadow-md     p-2 text-gray-900 border border-gray-300 rounded-lg ${Formik.errors.email && Formik.touched.email ? "border-red-500" :""} bg-gray-50 text-sm focus:ring-mainColor focus:border-mainColor `}
                      />
                    ...
                    <div className=" mt-4">
                      ...
                      <div className="relative">
                        <input
                          ...
                          name="password"
                          className={` w-3/4  place-self-center md:w-3/4 text-sm  shadow-md  placeholder:text-[#B0B0B0] ${Formik.errors.password && Formik.touched.password ? "border-red-500" :""}   p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50    focus:ring-mainColor focus:border-mainColor `} 
                        />
                        ...
                        <button type="button" onClick={() => setPassword(!password)}>
                          ...
                          <i
                            ...
                            } text-secondColor absolute ${Formik.errors.password ? "top-[18%]" :""} top-[30%] left-[65%] sm:left-[71%]`}
                          ></i>
                        </button>
